...
\rpgMakeCover[
    title = Verbose Magic,
    subtitle = Created by Cassandra de la Cruz-Munoz \\
	v0.0.0 \\
	\href{https://github.com/cass-dlcm/verbose-magic}{\includegraphics[scale=0.25]{img/github}} \\
	\href{https://itch.io/cass-dlcm/verbose-magic}{\includegraphics[scale=0.2]{img/itch}} \\
	\href{https://creativecommons.org/licenses/by-sa/4.0/}{\includegraphics[scale=0.2]{img/ccbysa.png}}
]
